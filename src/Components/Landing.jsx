        ...
        return(
            <div className=" w-[100%] bg-white flex gap-20 flex-col">
                ...
                <div className=" hidden1 w-[100%]   bg-white  flex justify-center">
                    <div className="w-[100%] h-[100vh] sm:h-[30vh] md:h-[30vh] bg-white mt-[-10rem] z-10 flex  justify-around flex-wrap xl:h-[25vh] gap-5 xl:flex-nowrap shadow-xl xl:w-[90%] text-center    ">
                ...
                <div className="w-full h-[inherte]  flex justify-center  ">
                    <div className=" w-[100%] md:w-full xl:w-[90%] h-[inherte] flex justify-around items-center  flex-wrap md:gap-10 xl:gap-2  ">
                ...
                <div className="w-full h-[inherte]  flex flex-col items-center">
                    <div className="w-[90%] h-[15vh] bg-[#c72626]  items-center justify-center flex">
                    <h1 className=" text-[0.9rem] md:text-[1.5rem] xl:text-[2.5rem] text-white  ">Municipal Engineer Association</h1>
                    </div>
